...
and integrate them directly into the gameplay.
...
2. Implement the core functions:
   ...
   - calculate(self)
     • Runs once per turn
     • Use for board analysis and planning
...
After uploading, you will be asked to provide:
...
You can select it and run it in the game.
...
- Start simple (e.g., always attack or random)
